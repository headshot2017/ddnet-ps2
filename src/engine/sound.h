...
public:
	...
	virtual int LoadWVFromMem(void *pData, unsigned DataSize, bool FromEditor = false) = 0;
	virtual int LoadOpusFromMem(void *pData, unsigned DataSize, bool FromEditor = false) = 0;
